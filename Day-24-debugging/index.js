...
Waiting:You should use console.clear() to clear the browser console.
Waiting:You should clear the console after your log.
*/
...
Waiting:Your code should keep the double quotes around the entire string.
